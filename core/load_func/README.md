...
Note that the payload len will be cast to `SIZE_T`. Keep this in mind when implementing new loader functions. The idea is to keep things as simple as possible in loader templates and do the heavy lifting in the internals.
